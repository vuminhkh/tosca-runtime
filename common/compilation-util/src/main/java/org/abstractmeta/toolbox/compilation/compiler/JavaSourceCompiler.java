...
public interface JavaSourceCompiler {
     ...
     * @return compilation unit
     */
    CompilationUnit createCompilationUnit(Path outputClassDirectory);
     ...
     */
    ClassLoader compile(CompilationUnit compilationUnit, String... compilerOptions) throws CompilationException;
     ...
     * @return class loader for the compiled classes
     */
    ClassLoader compile(ClassLoader parentClassLoader, CompilationUnit compilationUnit, String... compilerOptions) throws CompilationException;
     ...
     * @param compilationUnit compilation unit.
     */
    void persistCompiledClasses(CompilationUnit compilationUnit) throws IOException;
    ...
    interface CompilationUnit {
         ...
         * You can retrieve current jvm class path entries from {@link org.abstractmeta.toolbox.compilation.compiler.util.ClassPathUtil}
         * <p>
         * </p>
         *
