...
public class RuntimeConstant {
    ...
    public static final String AGENT_TYPE_BOOTSTRAP_VALUE = "bootstrap";

    public static final String AGENT_TYPE_DEPLOYMENT_VALUE = "deployment";

    public static final String COMPONENT_TYPE_LABEL = "com.toscaruntime.componentType";

    public static final String PROXY_TYPE_VALUE = "proxy";
}
