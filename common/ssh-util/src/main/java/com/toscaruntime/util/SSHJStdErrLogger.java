...
public class SSHJStdErrLogger implements Callable<Void> {
    ...
    public SSHJStdErrLogger(String operationName, String scriptName, Logger logger, InputStream scriptOutput) {
