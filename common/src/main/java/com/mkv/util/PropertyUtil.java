...
public class PropertyUtil {
    ...
    public static String getPropertyAsString(Map<String, Object> properties, String propertyName) {
        Object value = properties.get(propertyName);
        return value != null ? String.valueOf(properties.get(propertyName)) : null;
    }

    public static Properties toProperties(Map<String, Object> properties, String... ignoredKeys) {
