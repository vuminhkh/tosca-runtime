...
public class MockDeployment extends com.toscaruntime.sdk.Deployment {
    ...
    protected void addNodes() {
        ...
        addNode("WebServer", MockCompute.class.getName(), null, null, properties_WebServer, capabilities_properties_WebServer);
        ...
        addNode("Java", MockSoftware.class.getName(), "WebServer", "WebServer", properties_Java, capabilities_properties_Java);
        ...
        addNode("Tomcat", MockSoftware.class.getName(), "WebServer", "WebServer", properties_Tomcat, capabilities_properties_Tomcat);
        ...
        addNode("War", MockSoftware.class.getName(), "Tomcat", "Tomcat", properties_War, capabilities_properties_War);
        ...
        addNode("LoadBalancerServer", MockCompute.class.getName(), null, null, properties_LoadBalancerServer, capabilities_properties_LoadBalancerServer);
        ...
        addNode("ApacheLoadBalancer", MockSoftware.class.getName(), "LoadBalancerServer", "LoadBalancerServer", properties_ApacheLoadBalancer, capabilities_properties_ApacheLoadBalancer);
        ...
        addNode("Internet", MockNetwork.class.getName(), null, null, properties_Internet, capabilities_properties_Internet);

        addNode("Volume", MockVolume.class.getName(), "LoadBalancerServer", null, new HashMap<>(), new HashMap<>());
    }
    ...
    protected void addRelationships() {
        ...
        addRelationship("LoadBalancerServer", "Internet", properties_rel_LoadBalancerServer_Internet, Network.class.getName());

        Map<String, Object> properties_rel_War_Tomcat = new HashMap<>();
        addRelationship("War", "Tomcat", properties_rel_War_Tomcat, MockHostedOnRelationship.class.getName());

        Map<String, Object> properties_rel_War_ApacheLoadBalancer = new HashMap<>();
        addRelationship("War", "ApacheLoadBalancer", properties_rel_War_ApacheLoadBalancer, MockRelationship.class.getName());

        Map<String, Object> properties_rel_ApacheLoadBalancer_LoadBalancerServer = new HashMap<>();
        addRelationship("ApacheLoadBalancer", "LoadBalancerServer", properties_rel_ApacheLoadBalancer_LoadBalancerServer, MockHostedOnRelationship.class.getName());

        Map<String, Object> properties_rel_Java_WebServer = new HashMap<>();
        addRelationship("Java", "WebServer", properties_rel_Java_WebServer, MockHostedOnRelationship.class.getName());

        Map<String, Object> properties_rel_WebServer_Internet = new HashMap<>();
        addRelationship("WebServer", "Internet", properties_rel_WebServer_Internet, Network.class.getName());

        Map<String, Object> properties_rel_Tomcat_Java = new HashMap<>();
        addRelationship("Tomcat", "Java", properties_rel_Tomcat_Java, MockRelationship.class.getName());

        Map<String, Object> properties_rel_Tomcat_WebServer = new HashMap<>();
        addRelationship("Tomcat", "WebServer", properties_rel_Tomcat_WebServer, MockHostedOnRelationship.class.getName());

        addRelationship("Volume", "LoadBalancerServer", new HashMap<>(), AttachTo.class.getName());
    }
